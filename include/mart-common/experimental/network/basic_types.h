...
constexpr uint16_net_t to_net_order( uint16_host_t host_rep )
{
	return uint16_net_t( bswap( host_rep ) );
}
constexpr uint32_net_t to_net_order( uint32_host_t host_rep )
{
	return uint32_net_t( bswap( host_rep ) );
}
constexpr uint64_net_t to_net_order( uint64_host_t host_rep )
{
	return uint64_net_t( bswap( host_rep ) );
}

constexpr uint16_host_t to_host_order( uint16_net_t net_rep )
{
	return uint16_host_t( bswap( static_cast<uint16_t>( net_rep ) ) );
}
constexpr uint32_host_t to_host_order( uint32_net_t net_rep )
{
	return uint32_host_t( bswap( static_cast<uint32_t>( net_rep ) ) );
}
constexpr uint64_host_t to_host_order( uint64_net_t net_rep )
{
