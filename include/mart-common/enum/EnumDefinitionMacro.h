...
/* IMPLEMENTAITON note: Sanitized Version for Non-VS compiler would be:
*
...
#define MART_UTILS_IMPL_FE_2_P( WHAT, P, X, ... ) WHAT( P, X ) MART_UTILS_IMPL_FE_1( WHAT, __VA_ARGS__ )
#define MART_UTILS_IMPL_FE_3_P( WHAT, P, X, ... ) WHAT( P, X ) MART_UTILS_IMPL_FE_2( WHAT, __VA_ARGS__ )
#define MART_UTILS_IMPL_FE_4_P( WHAT, P, X, ... ) WHAT( P, X ) MART_UTILS_IMPL_FE_3( WHAT, __VA_ARGS__ )
...
*
*/


#define MART_UTILS_IMPL_GET_21ST_ARG( _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17, _18, _19, _20, NAME, ... )  NAME

//IMPLEMENTATION NOTE:  let <N> be the number of Variadic arguments, then this applies the macro  MART_UTILS_IMPL_FE_<N> on action and the variadic arguments
...
//IMPLEMENTATION NOTE: let <N> be the number of Variadic arguments, then this applies the macro  MART_UTILS_IMPL_FE_<N>_P on action, param and the variadic arguments
...
#define MART_UTILS_DEFINE_ENUM( NAME, BASE_TYPE, MEMBER_CNT, ... )                                                     \
	...
	constexpr std::array<NAME, MEMBER_CNT>								NAME##_Array		{{MART_UTILS_IMPL_FOR_EACH_P( MART_UTILS_IMPL_DEFINE_ENUM_MEMBER, NAME, __VA_ARGS__   )}};	\
	/*Arrays containing all enum names as mart::StringViews c-string or std::string*/																									\
	constexpr mart::EnumIdxArray<mart::StringView	, NAME, MEMBER_CNT>	NAME##_StringViews	{ MART_UTILS_IMPL_FOR_EACH( MART_UTILS_IMPL_DEFINE_ENUM_MEMBER_STRING_VIEW, __VA_ARGS__ )};	\
	constexpr mart::EnumIdxArray<const char*		, NAME, MEMBER_CNT>	NAME##_CStrings		{ MART_UTILS_IMPL_FOR_EACH( MART_UTILS_IMPL_DEFINE_ENUM_MEMBER_C_STRING,    __VA_ARGS__ )};	\
	const	  mart::EnumIdxArray<std::string		, NAME, MEMBER_CNT>	NAME##_CppStrings	{ MART_UTILS_IMPL_FOR_EACH( MART_UTILS_IMPL_DEFINE_ENUM_MEMBER_CPP_STRING,  __VA_ARGS__ )};	\
                                                                                                                       \
                                                                                                                       \
	constexpr int				mart_enumCnt_impl(const NAME*) { return MEMBER_CNT; }									   \
	...
	inline const std::string&	mart_to_string_impl( NAME id ) { return NAME##_CppStrings[id];	};                         \
                                                                                                                       \
	constexpr const mart::EnumIdxArray<mart::StringView, NAME, MEMBER_CNT>& mart_getEnumNames_impl( NAME* ) { return NAME##_StringViews; }	   \
